      ...
      <div className="flex flex-1 flex-col gap-2 px-3.5 pb-3.5 pt-3">
        ...
        <div className="mt-auto flex items-end justify-between gap-1 sm:gap-1.5">
          ...
          <button
            ...
            className="inline-flex items-center justify-center btn-circle shrink-0 whitespace-nowrap bg-primary px-2.5 sm:px-3 py-1 sm:py-1.5 text-[9px] sm:text-xs font-medium text-white shadow-sm transition-colors duration-200 hover:bg-primaryDark"
          >
